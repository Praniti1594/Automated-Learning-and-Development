...
import CreateGoal from './components/GoalPlan/GoalPlan.js';
  ...
  return (
    <Router> 
      <Routes> 
        ...
        <Route path="participant-dashboard/recommendation" element={<Recommendations />} />

        <Route path="/goalplan/:courseId" element={<CreateGoal />}  />
