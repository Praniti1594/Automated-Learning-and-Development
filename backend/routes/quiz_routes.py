...
def quiz_submission(quiz_id):
    ...
    answers = data.get('answers', {})  # Default to an empty dictionary if answers are not provided
    ...
    if not progress:
        progress = Progress(user_id=user_id, module_id=quiz.module_id, quiz_score=0, pass_fail_status=None)
